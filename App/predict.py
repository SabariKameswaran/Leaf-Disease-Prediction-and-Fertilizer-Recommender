...
class plantleaf:
    ...
    def predictPlantImage(self, image_file):
        ...
        if preds == 0:
            prediction = "Cerscospora. The Fertilizers are Penthiopyrad,Strobilurin,Copper Fungicides"
            return prediction
        elif preds == 1:
            prediction = "Healthy Leaf"
            return prediction
        elif preds == 2:
            prediction = "Leaf Rust. The Fertilizers are RANSOM,GREENCOP,DEFACTO"
            return prediction
        elif preds == 3:
            prediction = "Miner. The Fertilizers are Sevin, malathion, and lindane."
            return prediction
        
        
        else:
            prediction = "Phoma. The Fertilizers propiconazole and difenoconazole, and premixtures, pydiflumetofen + fludioxonil or pydiflumetofen + difenoconazol"
            return prediction